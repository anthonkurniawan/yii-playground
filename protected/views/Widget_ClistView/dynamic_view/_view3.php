...
<div class="view <?= $index%2==0?'vfirst':'vlast'; ?>" style="padding:5px;"> 
	<?php echo $index%2==0?'first':'last'; ?> <br>

	<div class="view2" style="display:table-cell;vertical-align:middle; border: 1px thin solid #0C0; width:200px; ">
	<!--<div class="left" style="border: 1px thin solid #0C0; background:#E9E9E9">-->
	...
	<!--<div class="left" style="background:#F4F4F4">-->
