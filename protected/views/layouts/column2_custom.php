...
<div class="container"><!--.container {width:950px;margin:0 auto;}-->
	<div class="span9"><!--.span-9 {width:350px;}-->
	...
	<div style="float:left; top: 120px; width:160px; height: auto;margin:0px 0px 0px 0px; padding:0" class="x-panel x-panel-default-framed"><!--.span-5 {width:190px;} .last {margin-right:0;}-->
		<?php
