<?php
class CTreeViewController extends Controller
{
...
//        echo CTreeView::saveDataAsJson($dataTree);
    ...
    {																							
	  ...
	  if( isset($person['parents']) !=null ) 
		return array('text'=>"<span class='folder'>". $person['name']. "</span>",'id'=>$person['id'],'hasChildren'=>isset($person['parents']));
	  else
		return array('text'=>"<span class='file'>". $person['name'],'id'=>$person['id'],'hasChildren'=>isset($person['parents']));
