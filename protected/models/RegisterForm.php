...
class RegisterForm extends CFormModel
{
    ...
    public function rules()
    {
        return array(
            ...
            array('email', 'email'),
            array('email', 'length', 'min' => TblUserMysql::EMAIL_MIN, 'max' => TblUserMysql::EMAIL_MAX),
            array('new_password,password_confirm', 'length', 'min' => TblUserMysql::PASSWORD_MIN, 'max' => TblUserMysql::USERNAME_MAX),
            array('username,email', 'unique', 'className' => 'TblUserMysql', 'skipOnError' => false),
