 ...
 * </code>
 */
class myPredis extends CApplicationComponent
{
    /**
    ...
    {
		 //Yii::setPathOfAlias('Predis', __DIR__.'/../../../../NOSQL/predis10');	
		 require_once ( __DIR__.'/../../../../../NOSQL/predis10/autoload.php');	
		...
		$this->client = new Predis\Client($this->clientOptions);
